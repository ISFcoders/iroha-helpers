...
/**
 * @param {string} value
 * @return {!proto.iroha.protocol.GetEngineResponse} returns this
 */
...
proto.iroha.protocol.Query.Payload.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      16,
      f,
      proto.iroha.protocol.GetEngineResponse.serializeBinaryToWriter
    );
  }
};
...
proto.iroha.protocol.Query.Payload.prototype.getGetEngineResponse = function() {
  return /** @type{?proto.iroha.protocol.GetEngineResponse} */ (
...
proto.iroha.protocol.Query.Payload.prototype.clearGetEngineResponse = function() {
  return this.setGetEngineResponse(undefined);
};
