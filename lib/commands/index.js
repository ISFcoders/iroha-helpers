...
function compareAndSetAccountDetail(commandOptions, _a) {
    var accountId = _a.accountId, key = _a.key, value = _a.value, oldValue = _a.oldValue;
 ...
 * @link https://iroha.readthedocs.io/en/latest/develop/api/commands.html#engine-call
 */
function engineCall(commandOptions, params) {
    return command(commandOptions, txHelper_1["default"].addCommand(txHelper_1["default"].emptyTransaction(), 'engineCall', validation_1["default"](params, ['callee', 'input'])));
}
/**
 * grantPermission
 * @param {Object} commandOptions
