...
var TxBuilder = /** @class */ (function () {
    ...
    TxBuilder.prototype.engineCall = function (params) {
        return new TxBuilder(txHelper_1["default"].addCommand(this.tx, 'engineCall', validation_1["default"](params, ['callee', 'input'])));
    };
